...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   medium(rando.Int32()),
		TwentyTwo:   medium(rando.Int32()),
		TwentyThree: medium(rando.Int32()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
