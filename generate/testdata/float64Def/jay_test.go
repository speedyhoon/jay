...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   float(rando.Float64()),
		TwentyTwo:   float(rando.Float64()),
		TwentyThree: float(rando.Float64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
