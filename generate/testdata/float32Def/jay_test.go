...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   float(rando.Float32()),
		TwentyTwo:   float(rando.Float32()),
		TwentyThree: float(rando.Float32()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
