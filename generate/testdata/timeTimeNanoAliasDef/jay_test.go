...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   tim(rando.TimeNano()),
		TwentyTwo:   tim(rando.TimeNano()),
		TwentyThree: tim(rando.TimeNano()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
