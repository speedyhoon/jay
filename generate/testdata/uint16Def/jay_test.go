...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   small(rando.Uint16()),
		TwentyTwo:   small(rando.Uint16()),
		TwentyThree: small(rando.Uint16()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
