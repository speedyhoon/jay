...
func TestFuzz_3(t *testing.T) {
	...
	actual = Three{
		One:   time.Duration(rando.Int64()),
		Two:   time.Duration(rando.Int64()),
		Three: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_4(t *testing.T) {
	...
	actual = Four{
		...
		Two:   time.Duration(rando.Int64()),
		Three: time.Duration(rando.Int64()),
		Four:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_5(t *testing.T) {
	...
	actual = Five{
		...
		Three: time.Duration(rando.Int64()),
		Four:  time.Duration(rando.Int64()),
		Five:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_7(t *testing.T) {
	...
	actual = Seven{
		...
		Five:  time.Duration(rando.Int64()),
		Six:   time.Duration(rando.Int64()),
		Seven: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_8(t *testing.T) {
	...
	actual = Eight{
		...
		Six:   time.Duration(rando.Int64()),
		Seven: time.Duration(rando.Int64()),
		Eight: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_9(t *testing.T) {
	...
	actual = Nine{
		...
		Seven: time.Duration(rando.Int64()),
		Eight: time.Duration(rando.Int64()),
		Nine:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_11(t *testing.T) {
	...
	actual = Eleven{
		...
		Nine:   time.Duration(rando.Int64()),
		Ten:    time.Duration(rando.Int64()),
		Eleven: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_12(t *testing.T) {
	...
	actual = Twelve{
		...
		Ten:    time.Duration(rando.Int64()),
		Eleven: time.Duration(rando.Int64()),
		Twelve: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_13(t *testing.T) {
	...
	actual = Thirteen{
		...
		Eleven:   time.Duration(rando.Int64()),
		Twelve:   time.Duration(rando.Int64()),
		Thirteen: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_14(t *testing.T) {
	...
	actual = Fourteen{
		...
		Twelve:   time.Duration(rando.Int64()),
		Thirteen: time.Duration(rando.Int64()),
		Fourteen: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_15(t *testing.T) {
	...
	actual = Fifteen{
		...
		Thirteen: time.Duration(rando.Int64()),
		Fourteen: time.Duration(rando.Int64()),
		Fifteen:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_16(t *testing.T) {
	...
	actual = Sixteen{
		...
		Fourteen: time.Duration(rando.Int64()),
		Fifteen:  time.Duration(rando.Int64()),
		Sixteen:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_17(t *testing.T) {
	...
	actual = Seventeen{
		...
		Fifteen:   time.Duration(rando.Int64()),
		Sixteen:   time.Duration(rando.Int64()),
		Seventeen: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_18(t *testing.T) {
	...
	actual = Eighteen{
		...
		Sixteen:   time.Duration(rando.Int64()),
		Seventeen: time.Duration(rando.Int64()),
		Eighteen:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_19(t *testing.T) {
	...
	actual = Nineteen{
		...
		Seventeen: time.Duration(rando.Int64()),
		Eighteen:  time.Duration(rando.Int64()),
		Nineteen:  time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_20(t *testing.T) {
	...
	actual = Twenty{
		...
		Eighteen:  time.Duration(rando.Int64()),
		Nineteen:  time.Duration(rando.Int64()),
		Twenty:    time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_21(t *testing.T) {
	...
	actual = TwentyOne{
		...
		Nineteen:  time.Duration(rando.Int64()),
		Twenty:    time.Duration(rando.Int64()),
		TwentyOne: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_22(t *testing.T) {
	...
	actual = TwentyTwo{
		...
		Twenty:    time.Duration(rando.Int64()),
		TwentyOne: time.Duration(rando.Int64()),
		TwentyTwo: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
...
func TestFuzz_23(t *testing.T) {
	...
	actual = TwentyThree{
		...
		TwentyOne:   time.Duration(rando.Int64()),
		TwentyTwo:   time.Duration(rando.Int64()),
		TwentyThree: time.Duration(rando.Int64()),
	}
	src := actual.MarshalJ()
	require.NoError(t, expected.UnmarshalJ(src))
