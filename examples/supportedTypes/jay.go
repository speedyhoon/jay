...
func (s Supported) MarshalJ() (b []byte) {
	...
	jay.WriteIntArch64(b[180:188], s.SubStruct.Int)
	...
	jay.WriteUintArch64(b[202:210], s.SubStruct.Uint)
...
func (s *Supported) UnmarshalJ(b []byte) error {
	...
	s.SubStruct.Int = jay.ReadIntArch64(b[180:188])
	...
	s.SubStruct.Uint = jay.ReadUintArch64(b[202:210])
