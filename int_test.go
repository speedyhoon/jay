...
func TestInt(t *testing.T) {
	...
	maxList := []int{
		0,
		jay.MinInt64, jay.MinInt56, jay.MinInt48, jay.MinInt40,
		jay.MinInt32, jay.MinInt24, jay.MinInt16, jay.MinInt8,
		jay.MaxInt8, jay.MaxInt16, jay.MaxInt24, jay.MaxInt32,
		jay.MaxInt40, jay.MaxInt48, jay.MaxInt56, jay.MaxInt64,
	}
	for n := range maxList {
...
func TestWriteInt(t *testing.T) {
	b := make([]byte, 9)
	jay.WriteInt(b, jay.MinInt64, jay.LenInt(jay.MinInt64))
	assert.Equal(t, []byte{8, 0, 0, 0, 0, 0, 0, 0, 128}, b)
	b = make([]byte, 8)
	jay.WriteInt(b, jay.MinInt56, jay.LenInt(jay.MinInt56))
	assert.Equal(t, []byte{7, 0, 0, 0, 0, 0, 0, 128}, b)
	b = make([]byte, 7)
	jay.WriteInt(b, jay.MinInt48, jay.LenInt(jay.MinInt48))
	assert.Equal(t, []byte{6, 0, 0, 0, 0, 0, 128}, b)
	b = make([]byte, 6)
	jay.WriteInt(b, jay.MinInt40, jay.LenInt(jay.MinInt40))
	assert.Equal(t, []byte{5, 0, 0, 0, 0, 128}, b)
	b = make([]byte, 5)
	jay.WriteInt(b, jay.MinInt32, jay.LenInt(jay.MinInt32))
	assert.Equal(t, []byte{4, 0, 0, 0, 128}, b)
	b = make([]byte, 4)
	jay.WriteInt(b, jay.MinInt24, jay.LenInt(jay.MinInt24))
	assert.Equal(t, []byte{3, 0, 0, 128}, b)
	b = make([]byte, 3)
	jay.WriteInt(b, jay.MinInt16, jay.LenInt(jay.MinInt16))
	assert.Equal(t, []byte{2, 0, 128}, b)
	b = make([]byte, 2)
	jay.WriteInt(b, jay.MinInt8, jay.LenInt(jay.MinInt8))
	assert.Equal(t, []byte{1, 128}, b)
	b = make([]byte, 1)
	jay.WriteInt(b, 0, jay.LenInt(0))
	assert.Equal(t, []byte{0}, b)
	b = make([]byte, 2)
	jay.WriteInt(b, jay.MaxInt8, jay.LenInt(jay.MaxInt8))
	assert.Equal(t, []byte{1, 127}, b)
	b = make([]byte, 3)
	jay.WriteInt(b, jay.MaxUint8, jay.LenInt(jay.MaxUint8))
	assert.Equal(t, []byte{2, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt16, jay.LenInt(jay.MaxInt16))
	assert.Equal(t, []byte{2, 255, 127}, b)
	b = make([]byte, 4)
	jay.WriteInt(b, jay.MaxUint16, jay.LenInt(jay.MaxUint16))
	assert.Equal(t, []byte{3, 255, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt24, jay.LenInt(jay.MaxInt24))
	assert.Equal(t, []byte{3, 255, 255, 127}, b)
	b = make([]byte, 5)
	jay.WriteInt(b, jay.MaxUint24, jay.LenInt(jay.MaxUint24))
	assert.Equal(t, []byte{4, 255, 255, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt32, jay.LenInt(jay.MaxInt32))
	assert.Equal(t, []byte{4, 255, 255, 255, 127}, b)
	b = make([]byte, 6)
	jay.WriteInt(b, jay.MaxUint32, jay.LenInt(jay.MaxUint32))
	assert.Equal(t, []byte{5, 255, 255, 255, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt40, jay.LenInt(jay.MaxInt40))
	assert.Equal(t, []byte{5, 255, 255, 255, 255, 127}, b)
	b = make([]byte, 7)
	jay.WriteInt(b, jay.MaxUint40, jay.LenInt(jay.MaxUint40))
	assert.Equal(t, []byte{6, 255, 255, 255, 255, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt48, jay.LenInt(jay.MaxInt48))
	assert.Equal(t, []byte{6, 255, 255, 255, 255, 255, 127}, b)
	b = make([]byte, 8)
	jay.WriteInt(b, jay.MaxUint48, jay.LenInt(jay.MaxUint48))
	assert.Equal(t, []byte{7, 255, 255, 255, 255, 255, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt56, jay.LenInt(jay.MaxInt56))
	assert.Equal(t, []byte{7, 255, 255, 255, 255, 255, 255, 127}, b)
	b = make([]byte, 9)
	jay.WriteInt(b, jay.MaxUint56, jay.LenInt(jay.MaxUint56))
	assert.Equal(t, []byte{8, 255, 255, 255, 255, 255, 255, 255, 0}, b)
	jay.WriteInt(b, jay.MaxInt64, jay.LenInt(jay.MaxInt64))
